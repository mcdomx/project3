...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('orders', '0018_auto_20180725_1834'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(default='None', on_delete=django.db.models.deletion.CASCADE, related_name='items', to='orders.Menu_categories')),
            ],
        ),
    ]
